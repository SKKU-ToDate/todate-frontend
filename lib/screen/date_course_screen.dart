...
class DateCoursePage extends StatefulWidget {
  const DateCoursePage({super.key});
  @override
  State<DateCoursePage> createState() => _DateCoursePageState();
}

class _DateCoursePageState extends State<DateCoursePage> {
